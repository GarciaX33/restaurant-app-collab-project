...
function displayRestaurantInfo() {
    ...
    $.ajax({
        ...
        $(".bottomCard8").append("<button onclick='window.location.href =&quot;" + br[7].restaurant.menu_url +  "&quot;'>View Menu</button>");
        // Card 9
        ...
        $(".bottomCard9").append("<button onclick='window.location.href =&quot;" + br[8].restaurant.menu_url +  "&quot;'>View Menu</button>");
        // Card 10
